...
export declare class CodeQualityService {
    private prisma;
    private codeQualityQueue;
    private readonly logger;
    constructor(prisma: PrismaService, codeQualityQueue: Queue);
    ...
    deleteReport(reportId: string, projectId: string, userId: string): Promise<void>;
}
