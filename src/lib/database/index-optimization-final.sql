-- Final Database Index Optimization
-- Based on exact schema columns that exist
...
-- Hackathon date filtering
CREATE INDEX IF NOT EXISTS "idx_hackathons_dates"
ON "hackathons" ("endDate", "startDate", "createdAt");

-- Hackathon slug lookups (URL routing)
CREATE INDEX IF NOT EXISTS "idx_hackathons_slug_lookup"
ON "hackathons" ("slug");
